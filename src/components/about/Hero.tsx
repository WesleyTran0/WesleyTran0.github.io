		...
		<section id="about" className="scroll-mt-28 py-12">
			<div>
				...
				<p className="mb-7 text-[19px] leading-[1.7] text-text [&_em]:border-b [&_em]:border-dotted [&_em]:border-accent/30 [&_em]:text-accent [&_em]:not-italic [&_em]:transition-colors [&_em]:hover:border-solid [&_em]:hover:border-accent [&_strong]:font-medium [&_strong]:text-text">
					I'm a security-driven developer and Cybersecurity student at Northeastern, bridging
					programming and digital security by developing secure software that enables future
					developers. Currently, you'll find me splitting time between{" "}
					<a href="https://www.sandboxnu.com/" target="_blank" rel="noopener noreferrer">
						sandbox
					</a>
					, where I build nonprofit software projects for the NEU community, and{" "}
					<a href="https://nuccdc.club/" target="_blank" rel="noopener noreferrer">
						NUCCDC
					</a>
					, where I compete in blue team focused cyber competition.
				</p>
			</div>
			<NowList />
			<InfoStrip />
